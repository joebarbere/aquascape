// HardscapeDragService tests. Stage 3 F3.1.
...
const sample = coreCatalog.byKind('hardscape')[0]!;

describe('HardscapeDragService', () => {
  let svc: HardscapeDragService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    svc = TestBed.inject(HardscapeDragService);
  });
  ...
  it('cancel() clears the active state without emitting drop', async () => {
