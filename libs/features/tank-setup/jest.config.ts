/* eslint-disable */
// Jest config for libs/features/tank-setup. F1.1 Phase B.
//
// Angular standalone components need jest-preset-angular to compile the
// component decorator + template, and a jsdom environment for the DOM
// queries the spec performs. Path mapping pulled from tsconfig.base.json so
...
const config: Config = {
  displayName: 'features-tank-setup',
  preset: 'jest-preset-angular',
  testEnvironment: 'jsdom',
  setupFilesAfterEnv: ['<rootDir>/src/test-setup.ts'],
  coverageReporters: ['text', 'text-summary', 'html', 'lcov', 'json-summary'],
  coverageDirectory: '../../../coverage/libs/features/tank-setup',
