...
| 11 F11.7 | Ambient polish — animated water surface, day-night cycle with sidebar slider, deterministic plant sway. Catalog `EquipmentEntry.photoperiodHours?`. Caustics + refraction + flow-coupled sway deferred to F11.7.1. | ✅ |
