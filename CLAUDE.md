...
| [`docs/caveats/livestock-ecs.md`](docs/caveats/livestock-ecs.md) | Stage 11 ECS — `libs/domain/livestock-ecs/`, `libs/domain/fish-anatomy/`, `libs/rendering/livestock-renderer-3d/`, the `LivestockSimulationService` in `apps/web`. Sim 30 Hz / render 60 Hz with accumulator + interpolation, determinism rules, system ordering. |
